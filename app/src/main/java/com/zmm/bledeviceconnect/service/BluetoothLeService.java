...
package com.zmm.bledeviceconnect.service;
...
//    public final static UUID UUID_SERVICE = UUID.fromString("0000fff0-0000-1000-8000-00805f9b34fb");
    ...
    public void WriteValueByte(byte[] bytes)
    {
    ...
    public void findService(List<BluetoothGattService> gattServices)
    {
    	...
    	{
    		Log.i(TAG, "01_uuid:"+gattService.getUuid().toString());
    		...
    		if(gattService.getUuid().toString().equalsIgnoreCase(UUID_SERVICE.toString()))
    		{
    			...
    			for (BluetoothGattCharacteristic gattCharacteristic :
                    gattCharacteristics) 
    			{
                    Log.i(TAG,"03_遍历uuid："+gattCharacteristic.getUuid().toString());
    				if(gattCharacteristic.getUuid().toString().equalsIgnoreCase(UUID_NOTIFY.toString()))
    				{
    					Log.i(TAG, "02_uuid UUID_NOTIFY :"+gattCharacteristic.getUuid().toString());
//    					Log.i(TAG, UUID_NOTIFY.toString());
    ...
    private void broadcastUpdate(final String action,
        ...
        if (data != null && data.length > 0) {
            ...
            System.out.println("接收数据："+ Arrays.toString(data));
    ...
    public class LocalBinder extends Binder {
        public BluetoothLeService getService(UUID uuidS,UUID uuidN) {
            UUID_SERVICE = uuidS;
            UUID_NOTIFY = uuidN;
