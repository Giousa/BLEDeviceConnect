...
public class BLERecyclerQueryAdapter extends RecyclerView.Adapter<BLERecyclerQueryAdapter.DeviceRecyclerViewHolder>   {

    private List<BleModel> deviceList;
    private OnItemClickListener mOnItemClickListener;

    public BLERecyclerQueryAdapter(List<BleModel> deviceNames) {
    ...
    public class DeviceRecyclerViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int position) {
            ...
            mDeviceId.setText("名称："+deviceList.get(position).getName()+",地址："+deviceList.get(position).getAddress());
        }
    }

    public void add(BleModel bleModel) {
        deviceList.add(bleModel);
